...
<form method="post" action="/employees/create">
   ...
   <div class="form-group">
      ...
      <input type="date" class="form-control" id="hire_date" name="hire_date" value="<?=set_value("hire_date"); ?>"/>
   </div>
   <div class="form-group">
...
<div class="form-group">
   ...
   <div class="form-group">
      ...
      <input type="text-area" size="100" class="form-control" id="notes" name="notes" value="<?=set_value("notes"); ?>"/>
   </div>
